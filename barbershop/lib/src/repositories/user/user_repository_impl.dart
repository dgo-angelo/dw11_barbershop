...
class UserRepositoryImpl implements UserRepository {
  ...
  Future<Either<RepositoryException, Nil>> registerAdmin(
    ...
    try {
      ...
      log('Falha ao registrar usuário administrador', error: e, stackTrace: s);
      return Failure(
        RepositoryException(
          message: 'Falha ao registrar usuário administrador',
        ),
      );
    }
  }
  ...
  Future<Either<RepositoryException, List<UserModel>>> getEmployees(
    ...
    try {
      ...
      final employees =
          data.map((user) => UserModelEmployee.fromMap(user)).toList();
      ...
      return Failure(RepositoryException(
          message: 'Erro ao converter colaboradores ( Json invalido '));
    }
  }
  ...
  Future<Either<RepositoryException, Nil>> registerEmployee(
    ...
    try {
      ...
      log('Erro colaborador', error: e, stackTrace: s);
      return Failure(
        RepositoryException(message: 'Erro colaborador'),
      );
    }
  }
}
